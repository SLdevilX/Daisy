...
en = {
    ...
    "Siapa ini yang bukan admin memberikan perintah kepada saya?": "මේ ඇඩ්මින් නැති මල්ලි මොකද්ද මට කරන්න කියන්නේ?😅",
    "Anda bukan admin di grup ini!": "අනී..පව් ඔයා මේකේ ඇඩ්මින් නෙමේනේ!",
    ...
    "language_help": """Not every SL group speaks English; some groups would rather have Dewmi respond in their own language.

This is where Dewmi come in; you can change most of Dewmi's replies to be in the Sinhala language!
...
I am a group manager bot created by [my master](tg://user?id={}) based on Project Dewmi written by [Lasiya](t.me/Danuma_admin_bot)
...
""",
    "help_text": """
ආයුබෝවන්!
 ඔයාව දැනුම @danuma01 සමූහයේ තවත් බොට් කෙනෙකුට සාදරයෙන් පිළිගන්නවා! Have a look at the following for an idea of some of \
...
Need a lot of work for [my creator](t.me/Danuma_admin_bot) to take me to my place now, and \
...
If you really are interested in donating, please join @danuma01 , Thank you 😁""",
    "Kembali": "Back",
...
""",
    ...
    "Telah terjadi kesalahan dalam import backup Emilia!\nGabung ke [Grup support](https://t.me/EmiliaOfficial) kami untuk melaporkan dan mengatasi masalah ini!\n\nTerima kasih": "Dewmi ගේ උපස්ථය ලෝඩ් කර ගැනීමේ සුළු ගැටලුවක් තිබුණි.. නැවත වෙනත් උපස්ථ පිටපතකින් උත්සාහ කර බලන්න!\nJoin our [Group support](https://t.me/danuma01) for reporting and troubleshooting this problem!\n\nThank you",
    ...
    "dilaporkan membuat saya lebih baik! Terima kasih! 🙂":
        ...
        "you have a problem with this, contact @Danuma_admin_bot with your backup file, so "
...
Note that files/photos from other bots can't be imported due to telegram restrictions. Except for Dewmi backup it self.
...
""",
    ...
    "Saya tidak dapat menemukan pengguna ini 😣": "මට ඒකව හොයාගන්න බෑ 😣",
    "Saya tidak akan BAN diri saya sendiri, apakah kamu gila? 😠": "මම මාවම එලෝගන්නෑ, තමුසෙට පිස්සුද? 😠",
    "Saya tidak bisa banned orang ini karena dia adalah admin 😒": "මට ඇඩ්මින්ල පන්නන්න බෑ බන්. මගේ අයිතිකාරය ඒකට ෆුල් ට්‍රයි එකක් දුන්නා. ඒඋනාට බැරි උනානේ... 😒",
    "Anda tidak punya hak untuk membatasi seseorang pada *{}*.": "ඔයාට මේ ගෲප් එකේ කවුරුවත් තහනම් කරන්න බෑ,ඔයා ඔයාට අදාල දෙයක් කරගන්න .",
    "Anda tidak punya hak untuk membatasi seseorang.": "ඔයාට කවුරුවත් තහනම් කරන්න බෑ ඔයා ඔයාට අදාල දෙයක් කරගන්න.",
    "Terbanned pada *{}*! 😝": "එයා තහනම් *{}*! 😝",
    "Terbanned! 😝": "බලං හිටිය හිටිය හරියන්නේ නෑ වැඩේ ඇද්දේ ! 😝",
    "Yah sial, aku tidak bisa banned pengguna itu 😒": "Shit යකෝ.. මට පන්නලා දාන්න විදිහක් නෑ නේ මේකව 😒",
    "Anda belum menetapkan waktu untuk banned pengguna ini!": "කෝ  කාලයක් කිව්වෙ නෑනෙ ඔයා! ඒයාට  වැඩේ දෙන්න",
    "Banned! Pengguna diblokir untuk *{}* pada *{}*.": "ඔන්න ඉල්ලං කෑවෙ දැං *{}* කාලෙකට *{}* තහනම්.",
    "Banned! Pengguna diblokir untuk {}.": "හරි! එයා තහනම් {}.",
    "Yah sial, aku tidak bisa menendang pengguna itu 😒": "දෙකක් දෙන්න විදිහක් නෑ නේ 😒",
    "Yahhh aku tidak akan melakukan itu 😝": "මම ඒක කරන්න යන්නෙ නෑ 😝",
    "Saya berharap saya bisa... tetapi Anda seorang admin 😒": "මට පුලුවන් උනානම් අනිව කරනව... හැබැයි ඔයා ඇඩ්මින්නේ.",
    "Saya tidak bisa menendang orang ini karena dia adalah admin 😒":"මට ඇඩ්මින්ලට පයින් ගහන්න බෑ",
    "Saya tidak akan menendang diri saya sendiri, apakah kamu gila? 😠":"මම මටම පයින් ගහගන්නෑ විසිවෙන්න දෙන්නෙ",
    "Tidak masalah 😊": "කිසි අවුලක් නෑ 😊",
    "Hah? Aku tidak bisa 🙄": " මට බෑ 🙄",
    "Bagaimana saya akan unban diri saya sendiri jika saya tidak ada di sini...? 🤔": "මම මාව අන්බෑන් කරගන්නෙ කෝමද මම මෙතන නැතුව...? 🤔",
    "Mengapa Anda mencoba unban seseorang yang sudah ada di obrolan? 😑": "චැන් එකේ දැනටමත් ඉන්න කෙනෙක් අන්බෑන් කරන්න උත්සාහ කරල වැඩක් නෑ? 😑",
    "Ya, pengguna ini dapat bergabung pada {}! 😁": "ම්.... ආපහු ජොයින් වෙන්න පුලාම් {}! 😁",
    "Ya, pengguna ini dapat bergabung! 😁": "ඔන්න ආපහු ජොයින් වෙන්න පුලාම්! 😁",
    "bans_help": """
...
Examples of time values: 4m = 4 minute, 3h = 3 hours, 6d = 6 days, 5w = 5 weeks.""",
    ...
    "Mengatakan kata '{}' yang ada di daftar hitam": "ඔන්න කිව්ව  ඒක මේ ගෲප් එකේ භාවිතානොවන වචනයක්",
    "{} di bisukan karena mengatakan kata '{}' yang ada di daftar hitam": "{} ඔයාව මියුට් කරා මියුට් කරා අනවශ්‍ය  විදිහට හැසිටුනු නිසා නිසා!! ඒවා මේකෙ තහනම්",
...
""",
    ...
    "Id {} adalah `{}`.": "{}' ගේ හැඳුනුම් අංකය තමයි `{}`.",
    "Id Anda adalah `{}`.": "ඔබේ හැඳුනුම් අංක තමයි `{}`.",
    "Id grup ini adalah `{}`.": "මේ ගෲප් හැඳුනුම් අංකය තමයි `{}`.",
    "Id grup tersebut adalah `{}`.": "ඒ ගෲප් හැඳුනුම් අංකය `{}`.",
...
""",
    ...
    "Terbisukan pada *{}*! 😆": "සද්ද නැතුව ඉන්න එහෙනං ටිකක් *{}*! 😆",
    "Terbisukan! 😆": "කට වැහුව එයාගෙ! 😆",
    ...
    "Pengguna ini tidak ada dalam obrolan!": "මේකා මේ චැට් එකේ නෑ!👿",
    ...
    "Pengguna ini sudah bisa untuk berbicara pada *{}*.": "මෙම පුද්ගලයාට මෙම ගෲප් එක තුල කතා කරන්න දැනටම අවසර තියෙයි.",
    "Dia telah disuarakan pada *{}*! ": "ඔයේ! ආපහු කතාකරන්න පුලුවන් දැන් *{}* එකේ.",
    "Pengguna ini sudah bisa untuk berbicara.": "මෙම පුද්ගලයාට මෙම ගෲප් එක තුල කත්තාකරන්න දැනටම අවසර තියෙනව.",
    ...
    "Saya benar-benar berharap dapat membisukan admin...": "මට හිතෙනව ඇඩ්මින්ල මියුට් කරන්න් තිබ්බනම් කියල!! ඒත් බෑනේ...ශික්",
    "Saya tidak akan membisukan diri saya sendiri, apakah kamu gila?": "මම මාවම මියුට් කරගන්නෙ නෑ.. අමු කාලද අයිසේ",
    "Anda belum menetapkan waktu untuk menonaktifkan pengguna ini!": "මෙයාගෙ කට වහල තියන්න වෙලාවකුත් කියන්න!",
    "Dibisukan untuk *{}* pada *{}*!": "එයාගේ සද්දෙ නැවැත්තුවා  *{}* වෙනකං in *{}*!",
    "Dibisukan untuk *{}*!": "ගොලුවෙක් කරා *{}*!",
    "Pengguna ini sudah dibungkam.": "එයා දැනටම මියුටඩ්🤐 .",
    "Yah sial, aku tidak bisa membisukan pengguna itu.": "රෙද්ද!! මට ඒකව මියුට් කරන්න බෑ.😒",
    "mute_help": """
*Admin only:*
...
""",
    ...
    "{} punya {}/{} peringatan... Hati-hati!": "{} ඔයාට {}/{} ක් අනතුරු හැඟවීම් තියෙනව. පරිස්ස්මෙන් ඉන්න අපි ඇහැ ගහගෙන  ඉන්නෙ!😡 ඊලග මොහොතේ ඔබ නෙරපාහරිනු ඇත !",
...
""",
    ...
    "exclusive_help": """
 - /stickerid: හැඳුනුම් අංකය ලබා ගැනීම සඳහා PM ට පිළිතුරු පණිවිඩ ස්ටිකර්
...
RUN_STRINGS = (
    "💔 මල්ලියෝ!! හැම කෙල්ලම ලයින් කරන්න එපා !!මට ආරංචි උනොත් 👠🏌️💔",
    "❤ ආදලෙයි ඉතිම්!! ❤",
    "හා... හා..... පොත් කියවන්න ආවනං කියවන්න විකාර නොකර!",
    "තමුසෙ පිස්සෙක්නෙ ඕයි!",
    "මොනාද  බලන්නේ...??",
    "කවුරුන් කෙසේ කීවද ඵරුස වචන භාවිතය ඔබේ ඔබේ මෙම්බර් සිප් එක නැති කරවයි!!",
    "හායි!! කෝමද පැටියෝ ❣❣",
    "මැරිලත්  ආදරෙයි.. අම්මපා",
    " මූ යකෝ!!",
    "🤗",
    "😍",
    "ඔයා හරි සෝයි අනේ.. සෝ කියුට්... 😋",
    "අපි දෙන්න එලිවෙනකං පොත් කියෝමු ",
    "මං නපුරුයි හරී😡!!",
    "🤪",
    "අඩ්ඩේහ්..! මේ මොකද කරන්නේ??",
    "පොඩිකාලෙ පෝලියෝ එක විද්දෙ නැද්ද",
    "ඊලදට එන්නෙ ඔයාගන්නම ඕනෙ කෝල් එකක්!",
    "කවුරු කොහොම් කිව්වත් අපි හම්බකරොත් අපි කනව!",
    "ආදරෙයි.. මැණික ❤❤",
    "අයියට කියනව්ව හොදේ @Danuma_admin_bot ❤",
    "ප‍ඹයා!🤣",
    "ඔයාට suprise එකක් තියෙයි.. /kickme කියල ගහල බලන්නකෝ 😂",
    "ඉගෙනගන්නවා නං අපේ චැනල් එකත් බලන්නකො @alxamas ",
    "ඔයාට suprise එකක් තියෙයි.. /kickme කියල ගහල බලන්නකෝ 😂",
    "ඇයි මොකෝ🤨..",
    "මොන විකාරයක්ද මේ පාඩුවෙ පොතක් කියවන්න අනේ",
    "පෝන් එක හිරවෙනවාද?? ගලක්මත තබා හොඳින් තලන්න නිසැක ප්‍රතිඵල",
    "කම්මැලී අප්පා",
    "තේ එකක් බොමුද?☕",
    "බය තරහ ඇති කරවයි. තරහ වයිරය උපදවයි. වරිරය පසුතැවීම ඇති කරයි. ඔබ බයෙන් ජීවත්වන තුරු ලංකාව එකතැන තියෙයි",
    "දවසට දෙවරක් දත් මදින්න. 😅 දැනුම අපෙන් පනිවිඩයක්",
    "හදිසි අවස්තාවකදී ගිලන්රථයක් ගෙන්වා ගැනීමට 1990 අමතන්න",
    "අපේ ගෲප් එකත් එක්ක අදම සෙට් වෙන්න t.me/danuma01 ❤",
    "ඔයාට කොච්චර සල්ලි තිබුනත් කොච්චර බලය තිබුනත් හිත පිරිසිදුව නැත්තං වැඩක් නෑ.",
    "මගේ නම්බර් එක ඕනෙද? 0779865432 💔",
    "මොනාද ඔබන්නෙ",
    "අයියට කියනව්ව හොදේ @Danuma_admin_bot ❤",
    "මොන විකාරයක්ද මේ පාඩුවෙ පොතක් කියවන්න අනේ",
    "ප‍ඹයා!🤣!",
...
RAMALAN_STRINGS = (
    ...
    "ඔබ  සඳහා අලුත් පොත් එක්වීමට  නියමිතයි",
    ...
    "මායාවක් සැබෑ නොවන බව දැන ගැනීමෙන් එය අඩු ඉන්ද්‍රජාලික දෙයක් නොවේ ඔබේ හැකියාව වැඩිකරගන්න",
    "ඔබ ඔබම වන්න ජීවිතය ලස්සන වේවි 🍴",
